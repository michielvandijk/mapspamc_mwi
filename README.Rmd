...
Note that it takes up to several hours to run the models, in particular when a resolution of 30 arc seconds is selected. The table below presents the model dimensions and model running time using a machine with an AMD Ryzen 7 PRO 7840U w/ Radeon 780M Graphics 3.30 GHz processor and 64 GB RAM, GAMS Distribution 49.3.0 and R version 4.5.1.
